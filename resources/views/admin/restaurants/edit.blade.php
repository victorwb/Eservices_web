            ...
            <div class="col-lg-9">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Edit a Restaurant</h6>
                </div>
                <div class="card-body">
                  <form action="{{route('restaurant.update', [$restaurant->id])}}" method="POST" enctype="multipart/form-data">@csrf
                  {{method_field('PUT')}}
                    ...
                    <div class="form-group">
                      ...
                      value="{{$restaurant->rating}}" name="rating">
                        @error('rating')
                        <span class="invalid-feedback" role="alert">
                          <strong>{{$message}}</strong>
                        </span>
                    ...
                    <div class="form-group">
                      ...
                      value="{{$restaurant->location}}" name="location">
                        @error('location')
                        <span class="invalid-feedback" role="alert">
                          <strong>{{$message}}</strong>
                        </span>
                    ...
                    <div class="form-group">
                      <div class="custom-file">
                        ...
                        <img src="{{Storage::url($restaurant->image)}}" width='150'/>
                        <br/><br/>
                      </div>
                    </div>
                    <!-- <div class="form-group">
