    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <a href="{{route('item.create')}}" class="btn btn-primary mb-1">Add new</a>
          <!-- Row -->
          <div class="row">
                  ...
                  <table class="table align-items-center table-flush" id="dataTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <th><a href="{{route('item.edit',[$item->id])}}" class="btn btn-secondary mb-1">edit</a></th>
                        <th><form action="{{route('item.destroy',[$item->id])}}" method="POST"
